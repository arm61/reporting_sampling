...
% ARJN the output of a Bayesian modelling process is a probability distribution for x. If everything is nice these will be Normally distributed, but not necessarily. We then report some statistical measures, e.g. mode/mean/median.
...
% Provide a reference for how statistical uncertainties are found, e.g. the appropriate place in Bevington.
